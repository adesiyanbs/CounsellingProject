  ...
  <c-box bg="#FBFCFF" pt="40px" px="150px">
    <c-flex w="100%" justify="space-between">
      ...
      <c-box as='router-link' to='/' mt="25px">
        <c-text>Are you a Student? Student's Page</c-text>
      </c-box>
    </c-flex>

    <c-box w="40%" textAlign='center' mt="40px" mb="45px" mx="auto"
    ...
    <c-box borderRadius='5px' w="40%" mx="auto" px="37px" class='box' pt="37px">
      ...
      <c-form-control >
        <c-input-group  mb="36px">
          ...
          <c-input borderRadius="5px" h="59x" placeholder="Staff ID " />
        </c-input-group>
        ...
        <c-button as='router-link' to='/admindash' mb='53px' h='50px' color='white' w='100%' borderRadius='12px' bg='#267FFF' fontSize='26px' fontWeight='400' >Login</c-button> 
      </c-form-control>
    </c-box>
